...
from langchain_classic.chains import create_retrieval_chain, LLMChain, RetrievalQA, StuffDocumentsChain
from langchain_classic_google_genai import GoogleGenerativeAIEmbeddings
